package com.example.usamanaseer.googlemap.widget;
...
import com.example.usamanaseer.googlemap.MainWeatherActivity;

import com.example.usamanaseer.googlemap.R;
import com.example.usamanaseer.googlemap.service.LocationUpdateService;
import com.example.usamanaseer.googlemap.utils.AppPreference;
import com.example.usamanaseer.googlemap.utils.AppWidgetProviderAlarm;
...
public class MoreWidgetProvider extends AppWidgetProvider {
        ...
        switch (intent.getAction()) {
            case Constants.ACTION_FORCED_APPWIDGET_UPDATE:
                if(AppPreference.isUpdateLocationEnabled(context)) {
                    ...
                    context.startService(new Intent(context, com.example.usamanaseer.googlemap.widget.MoreWidgetService.class));
                }
                break;
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        ...
        for (int appWidgetId : appWidgetIds) {
            ...
            Intent intentStartActivity = new Intent(context, MainWeatherActivity.class);
