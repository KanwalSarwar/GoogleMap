...
import com.example.usamanaseer.googlemap.adapter.WeatherForecastAdapter;
...
import static com.example.usamanaseer.googlemap.utils.Utils.getWeatherForecastUrl;
...
public class WeatherForecastActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       // ((com.example.usamanaseer.googlemap.GoodWeatherApp) getApplication()).applyTheme(this);
        super.onCreate(savedInstanceState);
        //setContentView(R.layout.activity_weather_forecast); //done by me

        /**
         * Adding our layout to parent class frame layout.
         */
        getLayoutInflater().inflate(R.layout.activity_weather_forecast, frameLayout);
        ...
        //setTitle(listArray[position]); //abi ye list mein add nhi wahan
    ...
    private void updateUI() {
        ...
        if (mWeatherForecastList.size() <5) { // <5
    ...
    public void onBackPressed() {
        if (isNavDrawerOpen()) {
           ...
           startActivity(new Intent(WeatherForecastActivity.this,MainWeatherActivity.class)) ;
           finish();
        }
    }
