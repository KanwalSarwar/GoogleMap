...
//            setTheme(R.style.AppLightTheme);
        ...
        //setContentView(R.layout.main); //comment

        /**
         * Adding our layout to parent class frame layout.
         */
        getLayoutInflater().inflate(R.layout.activity_currency_converter, frameLayout);
        ...
        //getActionBar().setDisplayShowTitleEnabled(false); //comment-- this gives exception
...
public void onBackPressed() {
        ...
        Intent i = new Intent(CurrencyConverterActivity.this,NearestPlacesActivity.class);
        startActivity(i);
        finish();
